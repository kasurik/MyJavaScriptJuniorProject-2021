...
var showCurrentTime = function () {
  ...
  // creating Date object here name as "currentTime"
  ...
  if (hours > noon) {
    hours -= 12; // hours= hours- 12 <--- same meaning !!!
  }
...
function resetAll() {
  ...
  //window.alert("test reset btn");

  var x = document.getElementById("wakeUpTimeSelector").selectedIndex;
  var y = document.getElementById("lunchTimeSelector").selectedIndex;
  var z = document.getElementById("napTimeSelector").selectedIndex;

  if (x != 0) {
    var dropDown = document.getElementById("wakeUpTimeSelector");
    dropDown.selectedIndex = 0;
  } else if (y != 0) {
    var dropDown = document.getElementById("lunchTimeSelector");
    dropDown.selectedIndex = 0;
  } else if (z != 0) {
    var dropDown = document.getElementById("napTimeSelector");
    dropDown.selectedIndex = 0;
  }
}
